                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="card mt-4">
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Five Things You Should Know Before You Jumping Into ReactJS <span aria-label="" role="img">🔯</span></h5>
                                <p className="card-text">Every front end developer and web developer knows how painful it is to write the same code at multiple places...</p>
                    ...
                    <div className="col-md-4">
                        <div className="card mt-4">
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Every Programmer Needs An Anti Blue Light Glass <span aria-label="" role="img">👓</span></h5>
