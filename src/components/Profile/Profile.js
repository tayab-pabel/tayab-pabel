    ...
    return (
        <div className="Profile container py-5">
            <div className="row d-flex justify-content-center align-items-center my-5">
                <div className="col-lg-7 pl-lg-5 pl-2 order-1 order-lg-0 py-4 py-md-5 text-left text-center text-md-left">
                    ...
                    <div className="social-links my-2">
                        ...
                        <a href="https://medium.com/@tayab_pabel" target="_blank" rel="noopener noreferrer"><i class="fab fa-medium-m"></i></a>
                    ...
                    <p className="description mt-3 mt-md-4 mb-4">I am a passionate Web Developer. I love to code modern and responsive layouts for web application. My core skill is based on JavaScript and I love to do most things using JavaScript. I am available for any kind of job opportunity that suits my interests.</p>
                    <Link to="#" className="btn mr-1">Get Resume</Link>
